...
class BookDescription extends StatefulWidget {
  ...
  BookDescription({
    @required this.book,
            ...
            book != null, 'Il parametro formale \'Book\' non deve essere null');
        ...
        child: SafeArea(
          child: Padding(
            ...
            child:
              ...
              SizedBox(height: 10),
              Text('Autore: ${widget.book.author}',
                  style: TextStyle(
                    color: Colors.grey,
                    fontSize: 16,
                  )),
              Text('Genere: ${widget.book.kind}',
                  style: TextStyle(
                    color: Colors.grey,
                    fontSize: 16,
                  )),
        ...
        onPressed: () async {
          if (widget.book.quantity > 0) {
            bool reserved = await reservationApi.addReservation(
                reservationApi.getUserId(), widget.book.id);
